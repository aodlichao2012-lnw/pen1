                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name2'); ?>"><?= _product_name2 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name3'); ?>"><?= _product_name3 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name4'); ?>"><?= _product_name4 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name5'); ?>"><?= _product_name5 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name6'); ?>"><?= _product_name6 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name7'); ?>"><?= _product_name7 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name8'); ?>"><?= _product_name8 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name10'); ?>"><?= _product_name9 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name11'); ?>"><?= _product_name10 ?></a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url('p_name12'); ?>"><?= _product_name11 ?></a></li>
