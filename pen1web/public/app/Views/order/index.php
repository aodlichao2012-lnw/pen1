                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?php echo $orders['product_num']; ?></td>
                                <td><?php echo $orders['customer_fname'] . " " . $orders['customer_lname']; ?></td>
                                <td><?php echo $orders['customer_email']; ?></td>
                                <td>
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="<?php echo base_url('detail_order/' . $orders['order_id']); ?>">
                                                <div class="btn btn-success" style="width: 100%;">แสดง</div>
                                            </a>
                                        </div>
                                        <div class="col-6">
                                            <a href="<?php echo base_url('order_delete/' . $orders['order_id']); ?>" onclick="return confirm('Are you sure you want to delete this item ?');">
