<div class="container-fluid" style="width: 90%;">
    <div class="row">
        ...
        <div class="d-flex justify-content-end">
            <a href="<?php echo site_url('/ProductInsert') ?>" class="btn btn-primary">เพิ่ม</a>
        </div>
        <div class="mt-3">
            <table id="datatable" class="table table-bordered" style="width:100%">
                <thead>
                    <tr>
                        <th class="text-center" style="width: 10%;">ลำดับสินค้า</th>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <!-- <td><?php //echo $products['product_detail'];
                                            ?></td> -->
                                <td class="text-center">
                                    ...
                                    <?php } else { ?>
                                        <img src="<?php echo base_url($products['product_image']); ?>" height="40">
                                    <?php } ?>
                                </td>
                                <td><?php echo $products['product_views']; ?></td>
                                <td><?php echo $products['product_lang']; ?></td>
                                <td>
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="<?php echo base_url('ProductUpdate/' . $products['product_id']); ?>">
                                                <div class="btn btn-warning" style="width: 100%;">แก้ไข</div>
                                            </a>
                                        </div>
                                        <div class="col-6">
                                            <a href="<?php echo base_url('delete/' . $products['product_id']); ?>" onclick="return confirm('Are you sure you want to delete this item?');">
