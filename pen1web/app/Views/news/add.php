<div class="container mt-4" style="width: 90%;">
    <div class="row">
        ...
        <hr>
        <div class="mt-3">
            <form action="<?= site_url('/Newsinsert'); ?>" method="post" name="add" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea name="news_detail" class="form-control" id="editor" cols="30" rows="10"></textarea>
                </div>
                <div class="form-group">
